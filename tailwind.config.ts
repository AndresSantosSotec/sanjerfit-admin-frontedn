		...
		extend: {
			colors: {
				...
				sanjer: {
					...
					dark: "#0a0f1e",
					darker: "#060b14",
					"dark-card": "rgba(15, 25, 50, 0.85)",
					"dark-surface": "rgba(13, 71, 161, 0.15)",
					"glass": "rgba(255, 255, 255, 0.05)",
					"glass-border": "rgba(255, 255, 255, 0.1)",
					"glow-green": "rgba(34, 197, 94, 0.4)",
					"glow-blue": "rgba(13, 71, 161, 0.5)",
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			boxShadow: {
				'glow-green': '0 0 20px rgba(34, 197, 94, 0.35), 0 0 40px rgba(34, 197, 94, 0.15)',
				'glow-blue': '0 0 20px rgba(13, 71, 161, 0.5)',
				'glass': '0 8px 32px rgba(0, 0, 0, 0.4)',
				'card-dark': '0 4px 24px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255,255,255,0.05)',
			},
			keyframes: {
				'accordion-down': {
					from: { height: '0' },
